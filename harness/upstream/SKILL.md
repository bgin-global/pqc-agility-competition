...
`optional/HOLONS.md` (κ-addressed interoperability, and why it is an auditor) ·
...
it) · `examples/field-guide/` (a runnable spar) · `optional/SPECIALISATION.md`
...
`optional/WIKI.md` (the Observe lane — auto-populating a federated wiki + the
