...
| [PQC Audit Index](https://pqaudit.org/) — independent index of PQC standards (16), algorithms (10, with parameter-set sizes and per-scheme audit-focus items), five jurisdiction migration timelines, twelve audit firms, and an [audit checklist](https://pqaudit.org/audit-checklist/); machine-readable at [`/api/index.json`](https://pqaudit.org/api/index.json) (`algorithms`, `standards`, `timelines`, `auditors`, `round3-signatures`, `checklist`, `faq`); last reviewed 2026-09-12; **secondary source** — every date and standard number links to its primary, which is what is cited here; no licence stated, so it is linked and not copied | `testbed/SCHEMES.md` (S-03 status, S-05 sizes, the on-ramp scope line), `evaluation/METRICS.md` (M-19 checklist seeds), `evaluation/RUBRIC.md` governance fit (timelines) |
| Published migration timelines that the governance-fit dimension (M-20, O4) can cite: NIST IR 8547 (draft: quantum-vulnerable 112-bit algorithms deprecated 2030, disallowed 2035) · CNSA 2.0 (in force; new NSS acquisitions compliant from 2027-01-01; exclusive use for signing and networking by 2030) · EU Coordinated Implementation Roadmap (adopted 2025-06-23: national roadmaps by end-2026, high-risk and critical infrastructure by end-2030, all systems by end-2035) · UK NCSC (2028 discovery, 2031 high-priority, 2035 complete) · U.S. NSM-10 and the Quantum Computing Cybersecurity Preparedness Act (2035 target) — as indexed 2026-09-12, primaries linked from the index | `evaluation/RUBRIC.md`, `OUTCOMES.md` O4 |
